...
This will attempt to pull every combination of monitoring location and project for the selected organization and date range
...
#combos cheat
combos <- filter(combos, Project1 == "Landfill Monitoring")
